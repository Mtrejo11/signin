...
var config = {
  apiKey: 'AIzaSyAiUl23PXIC71SIeMS3feeZKgxAxY-7n9o',
  authDomain: 'prueba-e9d93.firebaseapp.com/',
  databaseURL: 'https://prueba-e9d93.firebaseio.com/'
}
...
export default class App extends Component {
  ...
  _configureGoogleSignIn() {
    GoogleSignin.configure({
      webClientId: '853263245439-30u9nksqfbs74c7c8cha4db787spjvqb.apps.googleusercontent.com',
      offlineAccess: false,
    });
  }
  ...
  _signIn = async () => {
    ...
    GoogleSignin.signIn().then((data) => {
      ...
      alert('Google Login with user: '+($JSON.toString(currentUser.toJSON())));
    } )
    .catch((error)=>{
